...
```powershell
scp .\fapiao-deploy-20260809-ai-review.tar.gz root@SERVER_PUBLIC_IP:/root/
```
...
```bash
mkdir -p /opt/fapiao
tar -xzf /root/fapiao-deploy-20260809-ai-review.tar.gz -C /opt/fapiao --strip-components=1
cd /opt/fapiao
